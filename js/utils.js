    ...
    try {
        ...
        const categories = [
            ...
            },
            {
                id: 'pet',
                label: '萌宠屋',
                indexedDBNeedles: ['petGameState', 'pixelPetGame'],
                localStorageNeedles: []
            },
            {
                id: 'envelope',
                label: '信封投递',
                indexedDBNeedles: ['envelopeData'],
                localStorageNeedles: []
            },
            {
                id: 'moyu',
            ...
            },
            {
                id: 'call',
                label: '通话功能',
                indexedDBNeedles: ['callFeatureEnabled', 'callWindowPos', 'callWindowSize', 'callPillPos', 'callBgImageData'],
                localStorageNeedles: []
            },
            {
                id: 'groupChat',
                label: '群聊设置',
                indexedDBNeedles: ['groupChatSettings', 'gca_'],
                localStorageNeedles: []
            },
            {
                id: 'spark',
                label: '火花',
                indexedDBNeedles: ['chat_streak_data'],
                localStorageNeedles: []
            }
        ];
